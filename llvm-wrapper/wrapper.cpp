...
void add_comment_section(LLVMModuleRef module_ref, const char* compiler_string) {
  ...
  std::string asmText =
      ...
      ".string \"" + compiler_string + "\"\n";

  llvm::FunctionType* fnTy = llvm::FunctionType::get(llvm::Type::getVoidTy(context), false);

  llvm::Function* fn = llvm::Function::Create(fnTy, llvm::GlobalValue::InternalLinkage, "__emit_comment", module);
